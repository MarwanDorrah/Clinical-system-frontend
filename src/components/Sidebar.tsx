...
export default function Sidebar({ isOpen, onToggle }: SidebarProps) {
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      href: '/dashboard/clinical-decision-support',
      icon: Brain,
      roles: ['Doctor', 'Nurse']
    },
    {
  ...
  return (
    <>
      <aside
        ref={sidebarRef}
        className={`fixed left-0 top-0 h-full bg-white text-gray-800 transition-all duration-300 z-40 shadow-sm flex flex-col ${
